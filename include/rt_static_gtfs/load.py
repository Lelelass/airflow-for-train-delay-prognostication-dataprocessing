...
def _load_datalake(task_instance):
    data = task_instance.xcom_pull(task_ids = "exctract_liseberg.transform_stockholm_timezone")
...
def load_datalake():
    load = PythonOperator(task_id="load_datalake",
                        python_callable= _load_datalake)
    load
